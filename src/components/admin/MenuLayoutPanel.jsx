...
// ── Dietary restriction keys used in course editor ──
const DIETARY_KEYS = [
...
// ── MenuLayoutPanel — full course editor (course ordering, section gaps,
//    optional flags, short vs long menu logic, force pairing, positioning) ──
export default function MenuLayoutPanel({ menuCourses = [], onUpdateCourses, onSaveCourses }) {
